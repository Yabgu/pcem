...
enum { DMA_IDLE = 0, DMA_SEND, DMA_TARGET_RECEIVE, DMA_INITIATOR_RECEIVE };
...
void ncr5380_reset(ncr5380_t *ncr) { memset(ncr, 0, sizeof(ncr5380_t)); }
...
void ncr5380_write(uint32_t addr, uint8_t val, void *p) {
        ...
        case 1: /*Initiator Command Register*/
                if ((val & (ICR_BSY | ICR_SEL)) == (ICR_BSY | ICR_SEL) && (ncr->icr & (ICR_BSY | ICR_SEL)) == ICR_SEL) {
...
static void lcs6821n_write(uint32_t addr, uint8_t val, void *p) {
        ...
        //        CS,cpu_state.pc,  scsi->buffer_host_pos, scsi->status_ctrl);
...
static void *scsi_53c400_init(const char *bios_fn) {
        lcs6821n_t *scsi = (lcs6821n_t *)malloc(sizeof(lcs6821n_t));
        ...
        mem_mapping_add(&scsi->mapping, 0xdc000, 0x4000, lcs6821n_read, NULL, NULL, lcs6821n_write, NULL, NULL,
...
static void *scsi_t130b_init() {
        ...
        mem_mapping_add(&scsi->mapping, 0xdc000, 0x4000, t130b_read, NULL, NULL, t130b_write, NULL, NULL, scsi->bios_rom.rom, 0,
                        scsi);
        io_sethandler(0x0350, 0x0010, t130b_in, NULL, NULL, t130b_out, NULL, NULL, scsi);
...
static int scsi_lcs6821n_available() { return rom_present("Longshine LCS-6821N - BIOS version 1.04.bin"); }

static int scsi_rt1000b_available() { return rom_present("Rancho_RT1000_RTBios_version_8.10R.bin"); }

static int scsi_t130b_available() { return rom_present("trantor_t130b_bios_v2.14.bin"); }

device_t scsi_lcs6821n_device = {
        "Longshine LCS-6821N (SCSI)", 0, scsi_lcs6821n_init, scsi_53c400_close, scsi_lcs6821n_available, NULL, NULL, NULL, NULL};

device_t scsi_rt1000b_device = {
        "Ranco RT1000B (SCSI)", 0, scsi_rt1000b_init, scsi_53c400_close, scsi_rt1000b_available, NULL, NULL, NULL, NULL};

device_t scsi_t130b_device = {
        "Trantor T130B (SCSI)", 0, scsi_t130b_init, scsi_53c400_close, scsi_t130b_available, NULL, NULL, NULL, NULL};
