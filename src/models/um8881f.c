...
uint8_t um8881f_read(int func, int addr, void *priv) { return card_16[addr]; }
...
uint8_t um8886f_read(int func, int addr, void *priv) { return card_18[addr]; }
...
void um8881f_init() {
        ...
        card_16[2] = 0x81;
        card_16[3] = 0x88; /*UM8881 Host - PCI bridge*/
        card_18[2] = 0x86;
        card_18[3] = 0x88; /*UM8886 PCI - ISA bridge*/
}
