...
static void *joystick_standard_init() { return NULL; }
...
joystick_if_t joystick_standard = {.name = "Standard 2-button joystick(s)",
...
joystick_if_t joystick_standard_4button = {.name = "Standard 4-button joystick",
                                           .init = joystick_standard_init,
                                           .close = joystick_standard_close,
