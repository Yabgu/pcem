...
device_t adlib_device = {"AdLib", 0, adlib_init, adlib_close, NULL, NULL, NULL, NULL};

device_t adlib_mca_device = {"AdLib (MCA)", DEVICE_MCA, adlib_init, adlib_close, NULL, NULL, NULL, NULL};
