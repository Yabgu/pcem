...
static device_config_t wss_config[] = {{.name = "opl_emu",
...
device_t wss_device = {"Windows Sound System", 0, wss_init, wss_close, NULL, wss_speed_changed, NULL, NULL, wss_config};
