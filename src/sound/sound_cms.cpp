...
void cms_write(uint16_t addr, uint8_t val, void *p) {
        ...
        case 2:
                ...
                case 0x0D:
                        ...
                        cms->freq[chip][voice] =
                                (MASTER_CLOCK / 512 << (cms->latch[chip][voice] >> 8)) / (511 - (cms->latch[chip][voice] & 255));
                        break;
                case 0x10:
                case 0x11:
                case 0x12: /*Octave*/
                        ...
                        cms->freq[chip][voice] =
                                (MASTER_CLOCK / 512 << (cms->latch[chip][voice] >> 8)) / (511 - (cms->latch[chip][voice] & 255));
                        cms->freq[chip][voice + 1] = (MASTER_CLOCK / 512 << (cms->latch[chip][voice + 1] >> 8)) /
                                                     (511 - (cms->latch[chip][voice + 1] & 255));
                        break;
                case 0x16: /*Noise*/
...
device_t cms_device = {"Creative Music System / Game Blaster", 0, cms_init, cms_close, NULL, NULL, NULL, NULL};
