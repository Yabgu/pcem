...
static int xtide_available() { return rom_present("ide_xt.bin"); }

static int xtide_at_available() { return rom_present("ide_at.bin"); }

static int xtide_ps1_available() { return rom_present("ide_at_1_1_5.bin"); }

device_t xtide_device = {"XTIDE", 0, xtide_init, xtide_close, xtide_available, NULL, NULL, NULL, NULL};
device_t xtide_at_device = {"XTIDE (AT)", DEVICE_AT, xtide_at_init, xtide_close, xtide_at_available, NULL, NULL, NULL, NULL};
device_t xtide_ps1_device = {"XTIDE (PS/1)", DEVICE_PS1, xtide_ps1_init, xtide_close, xtide_ps1_available,
                             NULL,           NULL,       NULL,           NULL};
