...
enum { EEPROM_IDLE, EEPROM_GET_OPERATION, EEPROM_READ, EEPROM_WRITE };
...
device_t tandy_eeprom_device = {"Tandy EEPROM", 0, tandy_eeprom_init, tandy_eeprom_close, NULL, NULL, NULL, NULL, NULL};
