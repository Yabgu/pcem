...
enum { REG_BYTE, REG_WORD, REG_DWORD, REG_QWORD, REG_POINTER, REG_DOUBLE, REG_FPU_ST_BYTE, REG_FPU_ST_DOUBLE, REG_FPU_ST_QWORD };

enum { REG_INTEGER, REG_FP };
...
struct {
        ...
        /*[0] IREG_EAX*/        {REG_DWORD, &EAX, REG_INTEGER, REG_PERMANENT},
        /*[1] IREG_ECX*/        {REG_DWORD, &ECX, REG_INTEGER, REG_PERMANENT},
        /*[2] IREG_EDX*/        {REG_DWORD, &EDX, REG_INTEGER, REG_PERMANENT},
        /*[3] IREG_EBX*/        {REG_DWORD, &EBX, REG_INTEGER, REG_PERMANENT},
        /*[4] IREG_ESP*/        {REG_DWORD, &ESP, REG_INTEGER, REG_PERMANENT},
        /*[5] IREG_EBP*/        {REG_DWORD, &EBP, REG_INTEGER, REG_PERMANENT},
        /*[6] IREG_ESI*/        {REG_DWORD, &ESI, REG_INTEGER, REG_PERMANENT},
        /*[7] IREG_EDI*/        {REG_DWORD, &EDI, REG_INTEGER, REG_PERMANENT},

        /*[8] IREG_flags_op*/   {REG_DWORD, &cpu_state.flags_op, REG_INTEGER, REG_PERMANENT},
        /*[9] IREG_flags_res*/  {REG_DWORD, &cpu_state.flags_res, REG_INTEGER, REG_PERMANENT},
        /*[10] IREG_flags_op1*/ {REG_DWORD, &cpu_state.flags_op1, REG_INTEGER, REG_PERMANENT},
        /*[11] IREG_flags_op2*/ {REG_DWORD, &cpu_state.flags_op2, REG_INTEGER, REG_PERMANENT},

        /*[12] IREG_pc*/        {REG_DWORD, &cpu_state.pc, REG_INTEGER, REG_PERMANENT},
        /*[13] IREG_oldpc*/     {REG_DWORD, &cpu_state.oldpc, REG_INTEGER, REG_PERMANENT},

        /*[14] IREG_eaaddr*/    {REG_DWORD, &cpu_state.eaaddr, REG_INTEGER, REG_PERMANENT},
        /*[15] IREG_ea_seg*/    {REG_POINTER, &cpu_state.ea_seg, REG_INTEGER, REG_PERMANENT},

        /*[16] IREG_op32*/      {REG_DWORD, &cpu_state.op32, REG_INTEGER, REG_PERMANENT},
        /*[17] IREG_ssegsx*/    {REG_BYTE, &cpu_state.ssegs, REG_INTEGER, REG_PERMANENT},

        /*[18] IREG_rm_mod_reg*/{REG_DWORD, &cpu_state.rm_data.rm_mod_reg_data, REG_INTEGER, REG_PERMANENT},

        /*[19] IREG_ins*/       {REG_DWORD, &cpu_state.cpu_recomp_ins, REG_INTEGER, REG_PERMANENT},
        /*[20] IREG_cycles*/    {REG_DWORD, &cpu_state._cycles, REG_INTEGER, REG_PERMANENT},

        /*[21] IREG_CS_base*/   {REG_DWORD, &cpu_state.seg_cs.base, REG_INTEGER, REG_PERMANENT},
        /*[22] IREG_DS_base*/   {REG_DWORD, &cpu_state.seg_ds.base, REG_INTEGER, REG_PERMANENT},
        /*[23] IREG_ES_base*/   {REG_DWORD, &cpu_state.seg_es.base, REG_INTEGER, REG_PERMANENT},
        /*[24] IREG_FS_base*/   {REG_DWORD, &cpu_state.seg_fs.base, REG_INTEGER, REG_PERMANENT},
        /*[25] IREG_GS_base*/   {REG_DWORD, &cpu_state.seg_gs.base, REG_INTEGER, REG_PERMANENT},
        /*[26] IREG_SS_base*/   {REG_DWORD, &cpu_state.seg_ss.base, REG_INTEGER, REG_PERMANENT},

        /*[27] IREG_CS_seg*/    {REG_WORD, &cpu_state.seg_cs.seg, REG_INTEGER, REG_PERMANENT},
        /*[28] IREG_DS_seg*/    {REG_WORD, &cpu_state.seg_ds.seg, REG_INTEGER, REG_PERMANENT},
        /*[29] IREG_ES_seg*/    {REG_WORD, &cpu_state.seg_es.seg, REG_INTEGER, REG_PERMANENT},
        /*[30] IREG_FS_seg*/    {REG_WORD, &cpu_state.seg_fs.seg, REG_INTEGER, REG_PERMANENT},
        /*[31] IREG_GS_seg*/    {REG_WORD, &cpu_state.seg_gs.seg, REG_INTEGER, REG_PERMANENT},
        /*[32] IREG_SS_seg*/    {REG_WORD, &cpu_state.seg_ss.seg, REG_INTEGER, REG_PERMANENT},

        /* Temporary registers are stored on the stack, and are not guaranteed to
           be preserved across uOPs. They will not be written back if they will
           not be read again. */
        /*[33] IREG_temp0*/     {REG_DWORD, (void *)16, REG_INTEGER, REG_VOLATILE},
        /*[34] IREG_temp1*/     {REG_DWORD, (void *)20, REG_INTEGER, REG_VOLATILE},
        /*[35] IREG_temp2*/     {REG_DWORD, (void *)24, REG_INTEGER, REG_VOLATILE},
        /*[36] IREG_temp3*/     {REG_DWORD, (void *)28, REG_INTEGER, REG_VOLATILE},

        /*[37] IREG_FPU_TOP*/   {REG_DWORD, &cpu_state.TOP, REG_INTEGER, REG_PERMANENT},

        /*[38] IREG_temp0d*/    {REG_DOUBLE, (void *)40, REG_FP, REG_VOLATILE},
        /*[39] IREG_temp1d*/    {REG_DOUBLE, (void *)48, REG_FP, REG_VOLATILE},

        /*[40] IREG_ST0*/       {REG_FPU_ST_DOUBLE, &cpu_state.ST[0], REG_FP, REG_PERMANENT},
        /*[41] IREG_ST1*/       {REG_FPU_ST_DOUBLE, &cpu_state.ST[0], REG_FP, REG_PERMANENT},
        /*[42] IREG_ST2*/       {REG_FPU_ST_DOUBLE, &cpu_state.ST[0], REG_FP, REG_PERMANENT},
        /*[43] IREG_ST3*/       {REG_FPU_ST_DOUBLE, &cpu_state.ST[0], REG_FP, REG_PERMANENT},
        /*[44] IREG_ST4*/       {REG_FPU_ST_DOUBLE, &cpu_state.ST[0], REG_FP, REG_PERMANENT},
        /*[45] IREG_ST5*/       {REG_FPU_ST_DOUBLE, &cpu_state.ST[0], REG_FP, REG_PERMANENT},
        /*[46] IREG_ST6*/       {REG_FPU_ST_DOUBLE, &cpu_state.ST[0], REG_FP, REG_PERMANENT},
        /*[47] IREG_ST7*/       {REG_FPU_ST_DOUBLE, &cpu_state.ST[0], REG_FP, REG_PERMANENT},

        /*[48] IREG_tag0*/      {REG_FPU_ST_BYTE, &cpu_state.tag[0], REG_INTEGER, REG_PERMANENT},
        /*[49] IREG_tag1*/      {REG_FPU_ST_BYTE, &cpu_state.tag[0], REG_INTEGER, REG_PERMANENT},
        /*[50] IREG_tag2*/      {REG_FPU_ST_BYTE, &cpu_state.tag[0], REG_INTEGER, REG_PERMANENT},
        /*[51] IREG_tag3*/      {REG_FPU_ST_BYTE, &cpu_state.tag[0], REG_INTEGER, REG_PERMANENT},
        /*[52] IREG_tag4*/      {REG_FPU_ST_BYTE, &cpu_state.tag[0], REG_INTEGER, REG_PERMANENT},
        /*[53] IREG_tag5*/      {REG_FPU_ST_BYTE, &cpu_state.tag[0], REG_INTEGER, REG_PERMANENT},
        /*[54] IREG_tag6*/      {REG_FPU_ST_BYTE, &cpu_state.tag[0], REG_INTEGER, REG_PERMANENT},
        /*[55] IREG_tag7*/      {REG_FPU_ST_BYTE, &cpu_state.tag[0], REG_INTEGER, REG_PERMANENT},

        /*[56] IREG_ST0_i64*/   {REG_FPU_ST_QWORD, &cpu_state.MM[0], REG_FP, REG_PERMANENT},
        /*[57] IREG_ST1_i64*/   {REG_FPU_ST_QWORD, &cpu_state.MM[0], REG_FP, REG_PERMANENT},
        /*[58] IREG_ST2_i64*/   {REG_FPU_ST_QWORD, &cpu_state.MM[0], REG_FP, REG_PERMANENT},
        /*[59] IREG_ST3_i64*/   {REG_FPU_ST_QWORD, &cpu_state.MM[0], REG_FP, REG_PERMANENT},
        /*[60] IREG_ST4_i64*/   {REG_FPU_ST_QWORD, &cpu_state.MM[0], REG_FP, REG_PERMANENT},
        /*[61] IREG_ST5_i64*/   {REG_FPU_ST_QWORD, &cpu_state.MM[0], REG_FP, REG_PERMANENT},
        /*[62] IREG_ST6_i64*/   {REG_FPU_ST_QWORD, &cpu_state.MM[0], REG_FP, REG_PERMANENT},
        /*[63] IREG_ST7_i64*/   {REG_FPU_ST_QWORD, &cpu_state.MM[0], REG_FP, REG_PERMANENT},

        /*[64] IREG_MM0x*/      {REG_QWORD, &cpu_state.MM[0], REG_FP, REG_PERMANENT},
        /*[65] IREG_MM1x*/      {REG_QWORD, &cpu_state.MM[1], REG_FP, REG_PERMANENT},
        /*[66] IREG_MM2x*/      {REG_QWORD, &cpu_state.MM[2], REG_FP, REG_PERMANENT},
        /*[67] IREG_MM3x*/      {REG_QWORD, &cpu_state.MM[3], REG_FP, REG_PERMANENT},
        /*[68] IREG_MM4x*/      {REG_QWORD, &cpu_state.MM[4], REG_FP, REG_PERMANENT},
        /*[69] IREG_MM5x*/      {REG_QWORD, &cpu_state.MM[5], REG_FP, REG_PERMANENT},
        /*[70] IREG_MM6x*/      {REG_QWORD, &cpu_state.MM[6], REG_FP, REG_PERMANENT},
        /*[71] IREG_MM7x*/      {REG_QWORD, &cpu_state.MM[7], REG_FP, REG_PERMANENT},

        /*[72] IREG_NPXCx*/     {REG_WORD, &cpu_state.npxc, REG_INTEGER, REG_PERMANENT},
        /*[73] IREG_NPXSx*/     {REG_WORD, &cpu_state.npxs, REG_INTEGER, REG_PERMANENT},

        /*[74] IREG_flagsx*/    {REG_WORD, &cpu_state.flags, REG_INTEGER, REG_PERMANENT},
        /*[75] IREG_eflagsx*/   {REG_WORD, &cpu_state.eflags, REG_INTEGER, REG_PERMANENT},

        /*[76] IREG_CS_limit_low*/  {REG_DWORD, &cpu_state.seg_cs.limit_low, REG_INTEGER, REG_PERMANENT},
        /*[77] IREG_DS_limit_low*/  {REG_DWORD, &cpu_state.seg_ds.limit_low, REG_INTEGER, REG_PERMANENT},
        /*[78] IREG_ES_limit_low*/  {REG_DWORD, &cpu_state.seg_es.limit_low, REG_INTEGER, REG_PERMANENT},
        /*[79] IREG_FS_limit_low*/  {REG_DWORD, &cpu_state.seg_fs.limit_low, REG_INTEGER, REG_PERMANENT},
        /*[80] IREG_GS_limit_low*/  {REG_DWORD, &cpu_state.seg_gs.limit_low, REG_INTEGER, REG_PERMANENT},
        /*[81] IREG_SS_limit_low*/  {REG_DWORD, &cpu_state.seg_ss.limit_low, REG_INTEGER, REG_PERMANENT},

        /*[82] IREG_CS_limit_high*/ {REG_DWORD, &cpu_state.seg_cs.limit_high, REG_INTEGER, REG_PERMANENT},
        /*[83] IREG_DS_limit_high*/ {REG_DWORD, &cpu_state.seg_ds.limit_high, REG_INTEGER, REG_PERMANENT},
        /*[84] IREG_ES_limit_high*/ {REG_DWORD, &cpu_state.seg_es.limit_high, REG_INTEGER, REG_PERMANENT},
        /*[85] IREG_FS_limit_high*/ {REG_DWORD, &cpu_state.seg_fs.limit_high, REG_INTEGER, REG_PERMANENT},
        /*[86] IREG_GS_limit_high*/ {REG_DWORD, &cpu_state.seg_gs.limit_high, REG_INTEGER, REG_PERMANENT},
        /*[87] IREG_SS_limit_high*/ {REG_DWORD, &cpu_state.seg_ss.limit_high, REG_INTEGER, REG_PERMANENT},
};
...
static inline int ir_get_refcount(ir_reg_t ir_reg) { return reg_version[IREG_GET_REG(ir_reg.reg)][ir_reg.version].refcount; }
...
static void codegen_reg_load(host_reg_set_t *reg_set, codeblock_t *block, int c, ir_reg_t ir_reg) {
        ...
        case REG_WORD:
                ...
                if ((uintptr_t)ireg_data[IREG_GET_REG(ir_reg.reg)].p < 256)
                        codegen_direct_read_16_stack(block, reg_set->reg_list[c].reg,
                                                     (intptr_t)ireg_data[IREG_GET_REG(ir_reg.reg)].p);
                else
...
#endif
                if ((uintptr_t)ireg_data[IREG_GET_REG(ir_reg.reg)].p < 256)
                        codegen_direct_read_32_stack(block, reg_set->reg_list[c].reg,
                                                     (intptr_t)ireg_data[IREG_GET_REG(ir_reg.reg)].p);
                else
...
#endif
                if ((uintptr_t)ireg_data[IREG_GET_REG(ir_reg.reg)].p < 256)
                        codegen_direct_read_64_stack(block, reg_set->reg_list[c].reg,
                                                     (intptr_t)ireg_data[IREG_GET_REG(ir_reg.reg)].p);
                else
...
#endif
                if ((uintptr_t)ireg_data[IREG_GET_REG(ir_reg.reg)].p < 256)
                        codegen_direct_read_pointer_stack(block, reg_set->reg_list[c].reg,
                                                          (intptr_t)ireg_data[IREG_GET_REG(ir_reg.reg)].p);
                else
...
#endif
                if ((uintptr_t)ireg_data[IREG_GET_REG(ir_reg.reg)].p < 256)
                        codegen_direct_read_double_stack(block, reg_set->reg_list[c].reg,
                                                         (intptr_t)ireg_data[IREG_GET_REG(ir_reg.reg)].p);
                else
...
static void codegen_reg_writeback(host_reg_set_t *reg_set, codeblock_t *block, int c, int invalidate) {
        ...
        case REG_FPU_ST_DOUBLE:
                ...
                if (block->flags & CODEBLOCK_STATIC_TOP)
                        ...
                        codegen_direct_write_st_double(block, &cpu_state.ST[0], reg_set->regs[c].reg & 7,
                                                       reg_set->reg_list[c].reg);
                break;
...
void codegen_reg_write_imm(codeblock_t *block, ir_reg_t ir_reg, uint32_t imm_data) {
        ...
        case REG_DWORD:
                if ((uintptr_t)p < 256)
                        codegen_direct_write_32_imm_stack(block, (intptr_t)p, imm_data);
                else
                ...
                if (IREG_GET_REG(reg_set->regs[c].reg) == IREG_GET_REG(ir_reg.reg)) {
                        ...
                        if (reg_set->regs[c].version != ir_reg.version)
                                fatal("alloc_reg - host_regs[c].version != ir_reg.version  %i %p %p  %i %i\n", c, reg_set,
                                      &host_reg_set, reg_set->regs[c].reg, ir_reg.reg);
#endif
                        reg_set->locked |= (1 << c);
                        return;
                }
...
void codegen_reg_alloc_register(ir_reg_t dest_reg_a, ir_reg_t src_reg_a, ir_reg_t src_reg_b, ir_reg_t src_reg_c) {
        ...
        if (!ir_reg_is_invalid(dest_reg_a)) {
                if (!ir_reg_is_invalid(src_reg_a) && IREG_GET_REG(src_reg_a.reg) == IREG_GET_REG(dest_reg_a.reg) &&
                    src_reg_a.version == dest_reg_a.version - 1)
                        dest_reference++;
                if (!ir_reg_is_invalid(src_reg_b) && IREG_GET_REG(src_reg_b.reg) == IREG_GET_REG(dest_reg_a.reg) &&
                    src_reg_b.version == dest_reg_a.version - 1)
                        dest_reference++;
                if (!ir_reg_is_invalid(src_reg_c) && IREG_GET_REG(src_reg_c.reg) == IREG_GET_REG(dest_reg_a.reg) &&
                    src_reg_c.version == dest_reg_a.version - 1)
                        dest_reference++;
        }
...
ir_host_reg_t codegen_reg_alloc_read_reg(codeblock_t *block, ir_reg_t ir_reg, int *host_reg_idx) {
        ...
        if (c == reg_set->nr_regs) {
                ...
                for (c = 0; c < reg_set->nr_regs; c++) {
                        if (!(reg_set->locked & (1 << c)) && IREG_GET_REG(reg_set->regs[c].reg) != IREG_INVALID &&
                            !ir_get_refcount(reg_set->regs[c]))
                                break;
                }
                if (c == reg_set->nr_regs) {
        ...
        //        codegen_host_reg_list[c],  reg_set->regs[c].reg,reg_set->regs[c].version,  c);
...
#ifndef RELEASE_BUILD
                if (IREG_GET_REG(reg_set->regs[c].reg) != IREG_GET_REG(ir_reg.reg) ||
                    reg_set->regs[c].version > ir_reg.version - 1)
                        fatal("codegen_reg_alloc_write_reg sub_reg - doesn't match  %i %02x.%i %02x.%i\n", c,
                              reg_set->regs[c].reg, reg_set->regs[c].version, ir_reg.reg, ir_reg.version);
#endif
...
void codegen_reg_rename(codeblock_t *block, ir_reg_t src, ir_reg_t dst) {
        ...
        /*Search for required register*/
        for (c = 0; c < reg_set->nr_regs; c++) {
                if (!ir_reg_is_invalid(reg_set->regs[c]) && IREG_GET_REG(reg_set->regs[c].reg) == IREG_GET_REG(src.reg) &&
                    reg_set->regs[c].version == src.version)
                        break;
        }
#ifndef RELEASE_BUILD
        if (c == reg_set->nr_regs)
