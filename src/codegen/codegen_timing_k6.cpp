...
typedef enum decode_type_t { DECODE_SHORT, DECODE_LONG, DECODE_VECTOR } decode_type_t;
...
static const risc86_instruction_t *opcode_timings[256] = {
        ...
        /*60*/ &vector_pusha_op, &vector_popa_op, &vector_bound_op, &vector_arpl_op, INVALID, INVALID, INVALID, INVALID,
        ...
        /*      MOV*/
        /*b0*/ &limm_op, &limm_op, &limm_op, &limm_op, &limm_op, &limm_op, &limm_op, &limm_op, &limm_op, &limm_op, &limm_op,
        &limm_op, &limm_op, &limm_op, &limm_op, &limm_op,
        ...
        /*      AAM                        AAD                        SETALC                     XLAT*/
        &vector_alux6_op, &vector_alux3_op, &vector_alux1_op, &vector_xlat_op, INVALID, INVALID, INVALID, INVALID, INVALID,
...
static const risc86_instruction_t *opcode_timings_0f0f_mod3[256] = {
        ...
        INVALID,         INVALID, INVALID,  INVALID, INVALID,     &m3dn_op, INVALID,     INVALID,

        /*10*/ INVALID,  INVALID, INVALID,  INVALID, INVALID,     INVALID,  INVALID,     INVALID,
        INVALID,         INVALID, INVALID,  INVALID, INVALID,     &m3dn_op, INVALID,     INVALID,

        /*20*/ INVALID,  INVALID, INVALID,  INVALID, INVALID,     INVALID,  INVALID,     INVALID,
        INVALID,         INVALID, INVALID,  INVALID, INVALID,     INVALID,  INVALID,     INVALID,

        /*30*/ INVALID,  INVALID, INVALID,  INVALID, INVALID,     INVALID,  INVALID,     INVALID,
        INVALID,         INVALID, INVALID,  INVALID, INVALID,     INVALID,  INVALID,     INVALID,

        /*40*/ INVALID,  INVALID, INVALID,  INVALID, INVALID,     INVALID,  INVALID,     INVALID,
        INVALID,         INVALID, INVALID,  INVALID, INVALID,     INVALID,  INVALID,     INVALID,

        /*50*/ INVALID,  INVALID, INVALID,  INVALID, INVALID,     INVALID,  INVALID,     INVALID,
        INVALID,         INVALID, INVALID,  INVALID, INVALID,     INVALID,  INVALID,     INVALID,

        /*60*/ INVALID,  INVALID, INVALID,  INVALID, INVALID,     INVALID,  INVALID,     INVALID,
        INVALID,         INVALID, INVALID,  INVALID, INVALID,     INVALID,  INVALID,     INVALID,

        /*70*/ INVALID,  INVALID, INVALID,  INVALID, INVALID,     INVALID,  INVALID,     INVALID,
        INVALID,         INVALID, INVALID,  INVALID, INVALID,     INVALID,  INVALID,     INVALID,

        /*80*/ INVALID,  INVALID, INVALID,  INVALID, INVALID,     INVALID,  INVALID,     INVALID,
        INVALID,         INVALID, INVALID,  INVALID, INVALID,     INVALID,  INVALID,     INVALID,

        /*90*/ &m3dn_op, INVALID, INVALID,  INVALID, &m3dn_op,    INVALID,  &m3dn_op,    &m3dn_op,
        INVALID,         INVALID, &m3dn_op, INVALID, INVALID,     INVALID,  &m3dn_op,    INVALID,

        /*a0*/ &m3dn_op, INVALID, INVALID,  INVALID, &m3dn_op,    INVALID,  &mmx_mul_op, &mmx_mul_op,
        INVALID,         INVALID, &m3dn_op, INVALID, INVALID,     INVALID,  &m3dn_op,    INVALID,

        /*b0*/ &m3dn_op, INVALID, INVALID,  INVALID, &mmx_mul_op, INVALID,  &mmx_mul_op, &mmx_mul_op,
        INVALID,         INVALID, INVALID,  INVALID, INVALID,     INVALID,  INVALID,     &mmx_op,

        /*c0*/ INVALID,  INVALID, INVALID,  INVALID, INVALID,     INVALID,  INVALID,     INVALID,
        INVALID,         INVALID, INVALID,  INVALID, INVALID,     INVALID,  INVALID,     INVALID,

        /*d0*/ INVALID,  INVALID, INVALID,  INVALID, INVALID,     INVALID,  INVALID,     INVALID,
        INVALID,         INVALID, INVALID,  INVALID, INVALID,     INVALID,  INVALID,     INVALID,

        /*e0*/ INVALID,  INVALID, INVALID,  INVALID, INVALID,     INVALID,  INVALID,     INVALID,
        INVALID,         INVALID, INVALID,  INVALID, INVALID,     INVALID,  INVALID,     INVALID,

        /*f0*/ INVALID,  INVALID, INVALID,  INVALID, INVALID,     INVALID,  INVALID,     INVALID,
        INVALID,         INVALID, INVALID,  INVALID, INVALID,     INVALID,  INVALID,     INVALID,

};

static const risc86_instruction_t *opcode_timings_shift[8] = {&vector_alu_store_op, &vector_alu_store_op, &vector_alu_store_op,
                                                              &vector_alu_store_op, &vector_alu_store_op, &vector_alu_store_op,
                                                              &vector_alu_store_op, &vector_alu_store_op};
...
static const risc86_instruction_t *opcode_timings_shift_mod3[8] = {
        &vector_alu1_op, &vector_alu1_op, &vector_alu1_op, &vector_alu1_op, &alu_op, &alu_op, &alu_op, &alu_op};
static const risc86_instruction_t *opcode_timings_shift_b_mod3[8] = {
        &vector_alux1_op, &vector_alux1_op, &vector_alux1_op, &vector_alux1_op, &alux_op, &alux_op, &alux_op, &alux_op};
...
static const risc86_instruction_t *opcode_timings_80_mod3[8] = {
        &alux_op, &alux_op, &alux_store_op, &alux_store_op, &alux_op, &alux_op, &alux_op, &alux_op,
};
...
static const risc86_instruction_t *opcode_timings_8x_mod3[8] = {
        &alu_op, &alu_op, &alu_store_op, &alu_store_op, &alu_op, &alu_op, &alu_op, &alu_op,
};
...
static const risc86_instruction_t *opcode_timings_da_mod3[8] = {INVALID, INVALID, INVALID, INVALID,
                                                                /*                        FCOMPP*/
...
static const risc86_instruction_t *opcode_timings_df_mod3[8] = {INVALID, INVALID, INVALID, INVALID,
                                                                /*      FSTSW AX*/
...
codegen_timing_t codegen_timing_k6 = {codegen_timing_k6_start,       codegen_timing_k6_prefix,    codegen_timing_k6_opcode,
