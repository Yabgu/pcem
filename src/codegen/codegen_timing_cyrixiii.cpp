...
static uint32_t opcode_timings[256] = {
        ...
        /*80*/ CYCLES(1),  CYCLES(1),       CYCLES(1),  CYCLES(1),       CYCLES(2),  CYCLES(2),  CYCLES(5),  CYCLES(5),
        ...
        /*c0*/ CYCLES(1),  CYCLES(1),       CYCLES(5),  CYCLES(5),       CYCLES(6),  CYCLES(6),  CYCLES(1),  CYCLES(1),
        CYCLES(14),        CYCLES(5),       CYCLES(0),  CYCLES(0),       CYCLES(0),  CYCLES(0),  CYCLES(3),  CYCLES(0),
        /*d0*/ CYCLES(1),  CYCLES(1),       CYCLES(1),  CYCLES(1),       CYCLES(15), CYCLES(14), CYCLES(2),  CYCLES(4),
...
static uint32_t opcode_timings_d9_mod3[64] = {
        /*FLD*/
        FPU_CYCLES(2, 0, 0), FPU_CYCLES(2, 0, 0), FPU_CYCLES(2, 0, 0), FPU_CYCLES(2, 0, 0), FPU_CYCLES(2, 0, 0),
        FPU_CYCLES(2, 0, 0), FPU_CYCLES(2, 0, 0), FPU_CYCLES(2, 0, 0),
        /*FXCH*/
        FPU_CYCLES(2, 0, 0), FPU_CYCLES(2, 0, 0), FPU_CYCLES(2, 0, 0), FPU_CYCLES(2, 0, 0), FPU_CYCLES(2, 0, 0),
        FPU_CYCLES(2, 0, 0), FPU_CYCLES(2, 0, 0), FPU_CYCLES(2, 0, 0),
        /*FNOP*/
...
codegen_timing_t codegen_timing_cyrixiii = {codegen_timing_cyrixiii_start,     codegen_timing_cyrixiii_prefix,
                                            codegen_timing_cyrixiii_opcode,    codegen_timing_cyrixiii_block_start,
                                            codegen_timing_cyrixiii_block_end, codegen_timing_cyrixiii_jump_cycles};
