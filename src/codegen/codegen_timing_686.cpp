...
static uint32_t opcode_timings[256] = {
        ...
        /*60*/ PAIR_NP | CYCLES(6), PAIR_NP | CYCLES(6), PAIR_NP | CYCLES(11), PAIR_NP | CYCLES(9), INVALID, INVALID, INVALID,
        INVALID,
        ...
        /*      Jxx*/
        /*70*/ PAIR_X_BRANCH | CYCLES_BRANCH, PAIR_X_BRANCH | CYCLES_BRANCH, PAIR_X_BRANCH | CYCLES_BRANCH,
        PAIR_X_BRANCH | CYCLES_BRANCH, PAIR_X_BRANCH | CYCLES_BRANCH, PAIR_X_BRANCH | CYCLES_BRANCH,
        PAIR_X_BRANCH | CYCLES_BRANCH, PAIR_X_BRANCH | CYCLES_BRANCH, PAIR_X_BRANCH | CYCLES_BRANCH,
        PAIR_X_BRANCH | CYCLES_BRANCH, PAIR_X_BRANCH | CYCLES_BRANCH, PAIR_X_BRANCH | CYCLES_BRANCH,
        PAIR_X_BRANCH | CYCLES_BRANCH, PAIR_X_BRANCH | CYCLES_BRANCH, PAIR_X_BRANCH | CYCLES_BRANCH,
        ...
        /*      MOV*/
        /*b0*/ PAIR_XY | CYCLES_REG, PAIR_XY | CYCLES_REG, PAIR_XY | CYCLES_REG, PAIR_XY | CYCLES_REG, PAIR_XY | CYCLES_REG,
        PAIR_XY | CYCLES_REG, PAIR_XY | CYCLES_REG, PAIR_XY | CYCLES_REG, PAIR_XY | CYCLES_REG, PAIR_XY | CYCLES_REG,
        PAIR_XY | CYCLES_REG, PAIR_XY | CYCLES_REG, PAIR_XY | CYCLES_REG, PAIR_XY | CYCLES_REG, PAIR_XY | CYCLES_REG,
        PAIR_XY | CYCLES_REG,
        ...
        /*      AAM                                             AAD                                             SETALC XLAT*/
        PAIR_XY | CYCLES(18), PAIR_XY | CYCLES(7), PAIR_XY | CYCLES(2), PAIR_XY | CYCLES(4), INVALID, INVALID, INVALID, INVALID,
        INVALID, INVALID, INVALID, INVALID,
        /*      LOOPNE                                          LOOPE                                           LOOP JCXZ*/
        /*e0*/ PAIR_X_BRANCH | CYCLES_BRANCH, PAIR_X_BRANCH | CYCLES_BRANCH, PAIR_X_BRANCH | CYCLES_BRANCH,
        PAIR_X_BRANCH | CYCLES_BRANCH,
...
static uint32_t opcode_timings_0f[256] = {
        ...
        /*80*/ PAIR_X_BRANCH | CYCLES_BRANCH,
        PAIR_X_BRANCH | CYCLES_BRANCH,
        PAIR_X_BRANCH | CYCLES_BRANCH,
        PAIR_X_BRANCH | CYCLES_BRANCH,
        PAIR_X_BRANCH | CYCLES_BRANCH,
...
static uint32_t opcode_timings_f7[8] = {
        ...
        PAIR_XY | CYCLES_REG, INVALID, PAIR_XY | CYCLES(1), PAIR_XY | CYCLES(1),
        /*      MUL                                     IMUL                            DIV                             IDIV*/
        PAIR_NP | CYCLES_MULTI(4, 10), PAIR_NP | CYCLES_MULTI(4, 10), PAIR_NP | CYCLES_MULTI(19, 27),
        PAIR_NP | CYCLES_MULTI(22, 30)};
...
static uint32_t opcode_timings_d9_mod3[64] = {
        /*FLD*/
        PAIR_X | CYCLES(2), PAIR_X | CYCLES(2), PAIR_X | CYCLES(2), PAIR_X | CYCLES(2), PAIR_X | CYCLES(2), PAIR_X | CYCLES(2),
        PAIR_X | CYCLES(2), PAIR_X | CYCLES(2),
        /*FXCH*/
        PAIR_X | CYCLES(3), PAIR_X | CYCLES(3), PAIR_X | CYCLES(3), PAIR_X | CYCLES(3), PAIR_X | CYCLES(3), PAIR_X | CYCLES(3),
        PAIR_X | CYCLES(3), PAIR_X | CYCLES(3),
        /*FNOP*/
        PAIR_X | CYCLES(2), INVALID, INVALID, INVALID, INVALID, INVALID, INVALID, INVALID,
        /*FSTP*/
        PAIR_X | CYCLES(2), PAIR_X | CYCLES(2), PAIR_X | CYCLES(2), PAIR_X | CYCLES(2), PAIR_X | CYCLES(2), PAIR_X | CYCLES(2),
        PAIR_X | CYCLES(2), PAIR_X | CYCLES(2),
        /*      opFCHS                  opFABS*/
...
static uint32_t opcode_timings_da_mod3[8] = {PAIR_X | CYCLES(4),
                                             PAIR_X | CYCLES(4),
                                             PAIR_X | CYCLES(4),
                                             PAIR_X | CYCLES(4),
                                             INVALID,
...
static uint32_t opcode_timings_8x[8] = {PAIR_XY | CYCLES_RMW, PAIR_XY | CYCLES_RMW, PAIR_XY | CYCLES_RMW, PAIR_XY | CYCLES_RMW,
                                        PAIR_XY | CYCLES_RMW, PAIR_XY | CYCLES_RMW, PAIR_XY | CYCLES_RMW, PAIR_XY | CYCLES_RM};
static uint32_t opcode_timings_8x_mod3[8] = {PAIR_XY | CYCLES_REG, PAIR_XY | CYCLES_REG, PAIR_XY | CYCLES_REG,
                                             PAIR_XY | CYCLES_REG, PAIR_XY | CYCLES_REG, PAIR_XY | CYCLES_REG,
                                             PAIR_XY | CYCLES_REG, PAIR_XY | CYCLES_REG};
static uint32_t opcode_timings_81[8] = {PAIR_XY | CYCLES_RMW, PAIR_XY | CYCLES_RMW, PAIR_XY | CYCLES_RMW, PAIR_XY | CYCLES_RMW,
                                        PAIR_XY | CYCLES_RMW, PAIR_XY | CYCLES_RMW, PAIR_XY | CYCLES_RMW, PAIR_XY | CYCLES_RM};
static uint32_t opcode_timings_81_mod3[8] = {PAIR_XY | CYCLES_REG, PAIR_XY | CYCLES_REG, PAIR_XY | CYCLES_REG,
                                             PAIR_XY | CYCLES_REG, PAIR_XY | CYCLES_REG, PAIR_XY | CYCLES_REG,
                                             PAIR_XY | CYCLES_REG, PAIR_XY | CYCLES_REG};
...
void codegen_timing_686_opcode(uint8_t opcode, uint32_t fetchdat, int op_32, uint32_t op_pc) {
        ...
        if (prev_full) {
                ...
                if ((timings[opcode] & PAIR_MASK) == PAIR_NP) {
                        ...
                        //                        pclog("Not pairable %i\n", COUNT(prev_timings[prev_opcode], prev_op_32) +
                        //                        decode_delay);
        ...
        if (!prev_full) {
                ...
                if ((timings[opcode] & PAIR_MASK) == PAIR_NP || (timings[opcode] & PAIR_MASK) == PAIR_X_BRANCH) {
                        ...
                        //                        timings[opcode], timings[opcode] & PAIR_MASK, PAIR_X_BRANCH, timings,
                        //                        opcode_timings_0f, opcode_timings_0f_mod3);
                        prev_full = 1;
                        prev_opcode = opcode;
...
codegen_timing_t codegen_timing_686 = {codegen_timing_686_start,     codegen_timing_686_prefix,
                                       codegen_timing_686_opcode,    codegen_timing_686_block_start,
                                       codegen_timing_686_block_end, codegen_timing_686_jump_cycles};
