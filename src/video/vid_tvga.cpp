...
enum { TVGA_8900D = 0x33, TVGA_9000 = 0x23 };
...
static uint8_t crtc_mask[0x40] = {0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x7f, 0xff, 0x3f, 0x7f, 0xff, 0xff, 0xff, 0xff,
...
void tvga_out(uint16_t addr, uint8_t val, void *p) {
        ...
        case 0x3D5:
                ...
                //                if (svga->crtcreg != 0xC && svga->crtcreg != 0xE && svga->crtcreg != 0xF) pclog("CRTC R%02X =
...
static void tvga_recalcbanking(tvga_t *tvga) {
        ...
        //        svga->read_bank, svga->write_bank, svga->gdcreg[0xe], svga->gdcreg[0xf], svga->seqregs[0xe], tvga->tvga_3d8,
        //        tvga->tvga_3d9);
}
...
static void *tvga9000b_init() { return tvga_common_init("tvga9000b/BIOS.BIN", TVGA_9000, 512); }

static int tvga8900d_available() { return rom_present("trident.bin"); }
static int tvga9000b_available() { return rom_present("tvga9000b/BIOS.BIN"); }
...
static device_config_t tvga_config[] = {{.name = "memory",
                                         .description = "Memory size",
                                         .type = CONFIG_SELECTION,
                                         .selection = {{.description = "256 kB", .value = 256},
...
device_t tvga8900d_device = {
        "Trident TVGA 8900D", 0,          tvga8900d_init, tvga_close, tvga8900d_available, tvga_speed_changed, tvga_force_redraw,
        tvga_add_status_info, tvga_config};
device_t tvga9000b_device = {
        "Trident TVGA 9000B", 0,   tvga9000b_init, tvga_close, tvga9000b_available, tvga_speed_changed, tvga_force_redraw,
        tvga_add_status_info, NULL};
