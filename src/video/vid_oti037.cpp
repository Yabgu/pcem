...
uint8_t oti037_in(uint16_t addr, void *p) {
        ...
        case 0x3DE:
                ...
                break;
        case 0x3DF:
                if ((oti037->index & 0x1f) == 0x10)
                        temp = 0x18;
                else
                        temp = oti037->regs[oti037->index & 0x1f];
                break;
...
void oti037_recalctimings(svga_t *svga) {
        ...
        if (oti037->regs[0x14] & 0x08)
                svga->ma_latch |= 0x10000;
        if (oti037->regs[0x0d] & 0x0c)
                svga->rowoffset <<= 1;
...
void *oti037_common_init(char *bios_fn, int vram_size) {
        ...
        svga_init(&oti037->svga, oti037, vram_size << 10, oti037_recalctimings, oti037_in, oti037_out, NULL, NULL);
...
void *oti037_init() { return oti037_common_init("oti037/bios.bin", 256); }

static int oti037_available() { return rom_present("oti037/bios.bin"); }
...
device_t oti037_device = {
        "Oak OTI-037",         0, oti037_init, oti037_close, oti037_available, oti037_speed_changed, oti037_force_redraw,
