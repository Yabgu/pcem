...
void ati28800k_out(uint16_t addr, uint8_t val, void *p) {
        ...
        case 0x1CF:
                if (ati28800->index == 0xBF && ((ati28800->regs[0xBF] ^ val) & 0x20)) {
                        ...
                        //                        pclog("Switching mode to %s at %04X:%04X\n", ksc5601_mode_enabled ? "DBCS" :
                        //                        "SBCS", CS, cpu_state.oldpc);
                        svga_recalctimings(svga);
                }
                ...
                if (ati28800->get_korean_font_enabled) {
                        if ((ati28800->get_korean_font_base & 0x7F) > 0x20 && (ati28800->get_korean_font_base & 0x7F) < 0x7F)
                                fontdatksc5601_user[(ati28800->get_korean_font_kind & 4) * 24 +
                                                    (ati28800->get_korean_font_base & 0x7F) -
                                                    0x20][ati28800->get_korean_font_index] = val;
        ...
        case 0x3DE:
                if (ati28800->get_korean_font_enabled) {
                        ...
                        case 2: /* User defined font */
                                if ((ati28800->get_korean_font_base & 0x7F) > 0x20 &&
                                    (ati28800->get_korean_font_base & 0x7F) < 0x7F)
                                        temp = fontdatksc5601_user[(ati28800->get_korean_font_kind & 4) * 24 +
                                                                   (ati28800->get_korean_font_base & 0x7F) -
                                                                   0x20][ati28800->get_korean_font_index];
                                else
                                        temp = 0xFF;
                                ati28800->get_korean_font_index++;
                                break;
...
void *ati28800_init() {
        ...
        svga_init(&ati28800->svga, ati28800, 1 << 19, /*512kb*/
                  ati28800_recalctimings, ati28800_in, ati28800_out, NULL, NULL);
...
static int ati28800_available() { return rom_present("bios.bin"); }

static int ati28800k_available() { return rom_present("atikorvga.bin") && rom_present("ati_ksc5601.rom"); }
...
device_t ati28800_device = {"ATI-28800",           0,
                            ati28800_init,         ati28800_close,
                            ati28800_available,    ati28800_speed_changed,
                            ati28800_force_redraw, ati28800_add_status_info};

device_t ati28800k_device = {"ATI Korean VGA",      0,
                             ati28800k_init,        ati28800_close,
                             ati28800k_available,   ati28800_speed_changed,
                             ati28800_force_redraw, ati28800k_add_status_info};

device_t ati28800k_spc4620p_device = {"SVB-6120A",
                                      0,
...
device_t ati28800k_spc6033p_device = {"SVB-6120A",
                                      0,
