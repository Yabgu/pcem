...
enum { FIFO_INVALID = (0x00 << 24), FIFO_WRITE_BYTE = (0x01 << 24), FIFO_WRITE_MMU = (0x02 << 24) };
...
void et4000w32p_out(uint16_t addr, uint8_t val, void *p) {
        ...
        /*        if (ram[0x487] == 0x62)
                        fatal("mono\n");*/
        //        if (!(addr==0x3D4 && (val&~1)==0xE) && !(addr==0x3D5 && (crtcreg&~1)==0xE)) pclog("ET4000W32p out %04X %02X
        //        %04X:%04X  ",addr,val,CS,pc);
        ...
        case 0x217B:
                ...
                if (et4000->index == 0xef) {
                        if (PCI && et4000->is_pci)
                                return et4000->regs[0xef] | 0xe0; /*PCI*/
                        else
                                return et4000->regs[0xef] | 0x60; /*VESA local bus*/
                }
...
void et4000w32p_recalctimings(svga_t *svga) {
        ...
        case 2:
        case 3:
                svga->clock = (cpuclock * (double)(1ull << 32)) / icd2061_getfreq(&et4000->icd2061, 2);
                break;
        }
...
static void et4000w32p_accel_write_fifo(et4000w32p_t *et4000, uint32_t addr, uint8_t val) {
        ...
        case 0x7f8e:
                ...
                break;
        case 0x7f8f:
                et4000->acl.queued.xy_dir = val;
                break;
        case 0x7f90:
                et4000->acl.queued.pattern_wrap = val;
                break;
        case 0x7f92:
                et4000->acl.queued.source_wrap = val;
                break;
        case 0x7f98:
        ...
        case 0x7f9b:
                ...
                break;
        case 0x7f9c:
                et4000->acl.queued.ctrl_routing = val;
                break;
        case 0x7f9d:
                et4000->acl.queued.ctrl_reload = val;
                break;
        case 0x7f9e:
...
void et4000w32p_mmu_write(uint32_t addr, uint8_t val, void *p) {
        ...
        svga_t *svga = &et4000->svga;
        int bank;
        //        pclog("ET4K write %08X %02X %02X
        //        %04X(%08X):%08X\n",addr,val,et4000->acl.status,et4000->acl.internal.ctrl_routing,CS,cs,pc); et4000->acl.status
        //        |= ACL_RDST;
        switch (addr & 0x6000) {
        case 0x0000: /*MMU 0*/
        case 0x2000: /*MMU 1*/
...
uint8_t et4000w32p_mmu_read(uint32_t addr, void *p) {
        ...
        case 0x4000: /*MMU 2*/
                ...
                if (et4000->mmu.ctrl & (1 << bank)) {
                        ...
                        if ((et4000->acl.queued.ctrl_routing & 0x40) && !et4000->acl.cpu_dat_pos &&
                            !(et4000->acl.internal.ctrl_routing & 3))
                                et4000w32_blit(4, ~0, 0, 0, et4000);
                        /*???*/
                        return temp;
                }
        ...
        case 0x6000:
                ...
                case 0x7f36:
                        ...
                        //                        et4000->acl.internal.pos_y!=et4000->acl.internal.count_y) return
                        //                        et4000->acl.status | ACL_XYST;
                        return temp;
                case 0x7f80:
                        return et4000->acl.internal.pattern_addr;
                case 0x7f81:
                ...
                case 0x7f84:
                        return et4000->acl.internal.source_addr;
                case 0x7f85:
                ...
                case 0x7f88:
                        return et4000->acl.internal.pattern_off;
                case 0x7f89:
                        return et4000->acl.internal.pattern_off >> 8;
                case 0x7f8a:
                        return et4000->acl.internal.source_off;
                case 0x7f8b:
                        return et4000->acl.internal.source_off >> 8;
                case 0x7f8c:
                        return et4000->acl.internal.dest_off;
                case 0x7f8d:
                ...
                case 0x7f98:
                        return et4000->acl.internal.count_x;
                case 0x7f99:
                        return et4000->acl.internal.count_x >> 8;
                case 0x7f9a:
                        return et4000->acl.internal.count_y;
                case 0x7f9b:
                ...
                case 0x7fa0:
                        return et4000->acl.internal.dest_addr;
                case 0x7fa1:
...
void et4000w32_blit_start(et4000w32p_t *et4000) {
        ...
        if ((!(et4000->acl.internal.ctrl_routing & 7) || (et4000->acl.internal.ctrl_routing & 4)) &&
            !(et4000->acl.internal.ctrl_routing & 0x40))
        ...
        if (!(et4000->acl.internal.pattern_wrap & 0x40)) {
                et4000->acl.pattern_y =
                        (et4000->acl.pattern_addr / (et4000w32_wrap_x[et4000->acl.internal.pattern_wrap & 7] + 1)) &
                        (et4000w32_wrap_y[(et4000->acl.internal.pattern_wrap >> 4) & 7] - 1);
                et4000->acl.pattern_back &= ~(((et4000w32_wrap_x[et4000->acl.internal.pattern_wrap & 7] + 1) *
                                               et4000w32_wrap_y[(et4000->acl.internal.pattern_wrap >> 4) & 7]) -
                                              1);
        }
        ...
        if (!(et4000->acl.internal.source_wrap & 0x40)) {
                et4000->acl.source_y = (et4000->acl.source_addr / (et4000w32_wrap_x[et4000->acl.internal.source_wrap & 7] + 1)) &
                                       (et4000w32_wrap_y[(et4000->acl.internal.source_wrap >> 4) & 7] - 1);
                et4000->acl.source_back &= ~(((et4000w32_wrap_x[et4000->acl.internal.source_wrap & 7] + 1) *
                                              et4000w32_wrap_y[(et4000->acl.internal.source_wrap >> 4) & 7]) -
                                             1);
        }
...
void et4000w32_decy(et4000w32p_t *et4000) {
        ...
        if (et4000->acl.pattern_y < 0 && !(et4000->acl.internal.pattern_wrap & 0x40)) {
                ...
                et4000->acl.pattern_addr =
                        et4000->acl.pattern_back + (et4000w32_wrap_x[et4000->acl.internal.pattern_wrap & 7] *
                                                    (et4000w32_wrap_y[(et4000->acl.internal.pattern_wrap >> 4) & 7] - 1));
        }
        et4000->acl.source_y--;
        if (et4000->acl.source_y < 0 && !(et4000->acl.internal.source_wrap & 0x40)) {
                ...
                et4000->acl.source_addr =
                        et4000->acl.source_back + (et4000w32_wrap_x[et4000->acl.internal.source_wrap & 7] *
                                                   (et4000w32_wrap_y[(et4000->acl.internal.source_wrap >> 4) & 7] - 1));
                ;
        }
}
...
void et4000w32_blit(int count, uint32_t mix, uint32_t sdat, int cpu_input, et4000w32p_t *et4000) {
        ...
        if (!(et4000->acl.status & ACL_XYST))
                return;
        //        if (count>400) pclog("New blit - %i,%i %06X (%i,%i) %06X
        ...
        if (et4000->acl.internal.xy_dir & 0x80) /*Line draw*/
        {
                while (count--) {
                        if (bltout)
                                pclog("%i,%i : ", et4000->acl.internal.pos_x, et4000->acl.internal.pos_y);
                        ...
                        if (bltout)
                                pclog("%06X %06X ", (et4000->acl.pattern_addr + et4000->acl.pattern_x) & 0x1fffff,
                                      (et4000->acl.source_addr + et4000->acl.source_x) & 0x1fffff);
                        if (cpu_input == 2) {
                                source = sdat & 0xff;
                                sdat >>= 8;
                        }
                ...
                while (count--) {
                        ...
                        source = svga->vram[(et4000->acl.source_addr + et4000->acl.source_x) & 0x1fffff];
                        if (bltout)
                                pclog("%i %06X %06X %02X %02X  ", et4000->acl.pattern_y,
                                      (et4000->acl.pattern_addr + et4000->acl.pattern_x) & 0x1fffff,
                                      (et4000->acl.source_addr + et4000->acl.source_x) & 0x1fffff, pattern, source);
                        ...
                        out = 0;
                        if (bltout)
                                pclog("%06X %02X  %i %08X %08X  ", dest, et4000->acl.dest_addr, mix & 1, mix,
                                      et4000->acl.mix_addr);
                        if ((et4000->acl.internal.ctrl_routing & 0xa) == 8) {
                                mixdat = svga->vram[(et4000->acl.mix_addr >> 3) & 0x1fffff] & (1 << (et4000->acl.mix_addr & 7));
                                if (bltout)
                        ...
                        if (et4000->acl.internal.pos_x > et4000->acl.internal.count_x) {
                                if (et4000->acl.internal.xy_dir & 2) {
                                        et4000w32_decy(et4000);
                                        et4000->acl.mix_back = et4000->acl.mix_addr =
                                                et4000->acl.mix_back - (et4000->acl.internal.mix_off + 1);
                                        et4000->acl.dest_back = et4000->acl.dest_addr =
                                                et4000->acl.dest_back - (et4000->acl.internal.dest_off + 1);
                                } else {
                                        et4000w32_incy(et4000);
                                        et4000->acl.mix_back = et4000->acl.mix_addr =
                                                et4000->acl.mix_back + et4000->acl.internal.mix_off + 1;
...
void et4000w32p_hwcursor_draw(svga_t *svga, int displine) {
        ...
        for (x = 0; x < 64 - svga->hwcursor_latch.xoff; x += 4) {
                ...
                if (!(dat & 2))
                        ((uint32_t *)buffer32->line[displine])[svga->hwcursor_latch.x + x + 32] = (dat & 1) ? 0xFFFFFF : 0;
                else if ((dat & 3) == 3)
                        ((uint32_t *)buffer32->line[displine])[svga->hwcursor_latch.x + x + 32] ^= 0xFFFFFF;
                dat >>= 2;
                if (!(dat & 2))
                        ((uint32_t *)buffer32->line[displine])[svga->hwcursor_latch.x + x + 33] = (dat & 1) ? 0xFFFFFF : 0;
                else if ((dat & 3) == 3)
                        ((uint32_t *)buffer32->line[displine])[svga->hwcursor_latch.x + x + 33] ^= 0xFFFFFF;
                dat >>= 2;
                if (!(dat & 2))
                        ((uint32_t *)buffer32->line[displine])[svga->hwcursor_latch.x + x + 34] = (dat & 1) ? 0xFFFFFF : 0;
                else if ((dat & 3) == 3)
                        ((uint32_t *)buffer32->line[displine])[svga->hwcursor_latch.x + x + 34] ^= 0xFFFFFF;
                dat >>= 2;
                if (!(dat & 2))
                        ((uint32_t *)buffer32->line[displine])[svga->hwcursor_latch.x + x + 35] = (dat & 1) ? 0xFFFFFF : 0;
                else if ((dat & 3) == 3)
...
void *et4000w32p_init() {
        ...
        svga_init(&et4000->svga, et4000, vram_size << 20, et4000w32p_recalctimings, et4000w32p_in, et4000w32p_out,
                  et4000w32p_hwcursor_draw, NULL);
        ...
        mem_mapping_add(&et4000->linear_mapping, 0, 0, svga_read_linear, svga_readw_linear, svga_readl_linear, svga_write_linear,
                        svga_writew_linear, svga_writel_linear, NULL, 0, &et4000->svga);
        mem_mapping_add(&et4000->mmu_mapping, 0, 0, et4000w32p_mmu_read, NULL, NULL, et4000w32p_mmu_write, NULL, NULL, NULL, 0,
                        et4000);
...
int et4000w32p_available() { return rom_present("et4000w32.bin"); }
...
void et4000w32p_add_status_info(char *s, int max_len, void *p) {
        ...
        sprintf(temps, "%f%% CPU\n%f%% CPU (real)\n\n", ((double)et4000->blitter_time * 100.0) / timer_freq,
                ((double)et4000->blitter_time * 100.0) / status_diff);
...
device_t et4000w32p_device = {"Tseng Labs ET4000/w32p", 0,
                              et4000w32p_init,          et4000w32p_close,
                              et4000w32p_available,     et4000w32p_speed_changed,
                              et4000w32p_force_redraw,  et4000w32p_add_status_info,
                              et4000w32p_config};
