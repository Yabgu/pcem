        ...
        case 0x3c2:
                if (ati18800->is_ega) {
                        if ((val & 0x80) != (svga->miscout & 0x80)) {
                                ...
                                if (val & 0x80) {
                                        for (c = 0; c < 256; c++) {
                                                ati18800->svga.pallook[c] =
                                                        makecol32(((c >> 2) & 1) * 0xaa, ((c >> 1) & 1) * 0xaa, (c & 1) * 0xaa);
                                                ati18800->svga.pallook[c] += makecol32(
                                                        ((c >> 5) & 1) * 0x55, ((c >> 4) & 1) * 0x55, ((c >> 3) & 1) * 0x55);
                                        }
                                        ...
                                        for (c = 0; c < 256; c++) {
                                                if ((c & 0x17) == 6)
                                                        ...
                                                        ati18800->svga.pallook[c] = makecol32(
                                                                ((c >> 2) & 1) * 0xaa, ((c >> 1) & 1) * 0xaa, (c & 1) * 0xaa);
                                                        ati18800->svga.pallook[c] +=
                                                                makecol32(((c >> 4) & 1) * 0x55, ((c >> 4) & 1) * 0x55,
                                                                          ((c >> 4) & 1) * 0x55);
                                                }
                                        }
...
uint8_t ati18800_in(uint16_t addr, void *p) {
        ...
        case 0x3c2:
                if (ati18800->is_ega) {
                        ...
                        case 0xc:
                                return (ati18800->ega_switches & 1) ? 0x10 : 0;
                        case 0x8:
                                return (ati18800->ega_switches & 2) ? 0x10 : 0;
                        case 0x4:
                                return (ati18800->ega_switches & 4) ? 0x10 : 0;
                        case 0x0:
                                return (ati18800->ega_switches & 8) ? 0x10 : 0;
                        }
                }
                break;
...
static void ega_wonder_800_recalctimings(svga_t *svga) {
        ...
        case 1:
                ...
                break;
        case 4:
                svga->clock = (cpuclock * (double)(1ull << 32)) / 14318181.0;
                break;
        case 5:
                svga->clock = (cpuclock * (double)(1ull << 32)) / 16257000.0;
                break;
        case 7:
        default:
...
void *ati18800_init() {
        ...
        svga_init(&ati18800->svga, ati18800, 1 << 19, /*512kb*/
                  NULL, ati18800_in, ati18800_out, NULL, NULL);
...
void *ega_wonder_800_init() {
        ...
        svga_init(&ati18800->svga, ati18800, 1 << 18, /*256kb*/
                  ega_wonder_800_recalctimings, ati18800_in, ati18800_out, NULL, NULL);
...
static int ati18800_available() { return rom_present("vgaedge16.vbi"); }

static int ega_wonder_800_available() { return rom_present("ATI EGA Wonder 800+ N1.00.BIN"); }
...
device_t ati18800_device = {"ATI-18800",           0,
                            ati18800_init,         ati18800_close,
                            ati18800_available,    ati18800_speed_changed,
                            ati18800_force_redraw, ati18800_add_status_info};

device_t ati_ega_wonder_800_device = {"ATI EGA Wonder 800+",    0,
                                      ega_wonder_800_init,      ati18800_close,
                                      ega_wonder_800_available, ati18800_speed_changed,
                                      ati18800_force_redraw,    ati18800_add_status_info};
