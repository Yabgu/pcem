...
void loadnvr() {
        ...
        case ROM_PC1512:
                ...
                break;
        case ROM_PC1640:
                f = nvrfopen("pc1640.nvr", "rb");
                break;
        case ROM_PC200:
                f = nvrfopen("pc200.nvr", "rb");
                break;
        case ROM_PC2086:
                f = nvrfopen("pc2086.nvr", "rb");
                break;
        case ROM_PC3086:
                f = nvrfopen("pc3086.nvr", "rb");
                break;
        case ROM_PC5086:
                f = nvrfopen("pc5086.nvr", "rb");
                break;
        case ROM_PPC512:
                f = nvrfopen("ppc512.nvr", "rb");
                break;
        case ROM_IBMAT:
                f = nvrfopen("at.nvr", "rb");
                break;
        case ROM_IBMXT286:
                f = nvrfopen("ibmxt286.nvr", "rb");
                break;
        case ROM_IBMPS1_2011:
                f = nvrfopen("ibmps1_2011.nvr", "rb"); /*nvrmask = 127; */
                break;
        case ROM_IBMPS1_2121:
                f = nvrfopen("ibmps1_2121.nvr", "rb");
                nvrmask = 127;
                break;
        case ROM_IBMPS2_M30_286:
                f = nvrfopen("ibmps2_m30_286.nvr", "rb"); /*nvrmask = 127; */
                break;
        case ROM_IBMPS2_M50:
                f = nvrfopen("ibmps2_m50.nvr", "rb");
                break;
        case ROM_IBMPS2_M55SX:
                f = nvrfopen("ibmps2_m55sx.nvr", "rb");
                break;
        case ROM_IBMPS2_M80:
                f = nvrfopen("ibmps2_m80.nvr", "rb");
                break;
        case ROM_CMDPC30:
                f = nvrfopen("cmdpc30.nvr", "rb");
                nvrmask = 127;
                break;
        case ROM_AMI286:
                ...
                break;
        case ROM_TG286M:
                f = nvrfopen("tg286m.nvr", "rb");
                nvrmask = 127;
                break;
        case ROM_AWARD286:
                f = nvrfopen("award286.nvr", "rb");
                nvrmask = 127;
                break;
        case ROM_GDC212M:
                f = nvrfopen("gdc212m.nvr", "rb");
                nvrmask = 127;
                break;
        ...
        case ROM_GW286CT:
                ...
                break;
        case ROM_SPC4200P:
                f = nvrfopen("spc4200p.nvr", "rb");
                nvrmask = 127;
                break;
        case ROM_SPC4216P:
                f = nvrfopen("spc4216p.nvr", "rb");
                nvrmask = 127;
                break;
        case ROM_SPC4620P:
                f = nvrfopen("spc4620p.nvr", "rb");
                nvrmask = 127;
                break;
        case ROM_SPC6000A:
                f = nvrfopen("spc6000a.nvr", "rb");
                nvrmask = 127;
                break;
        case ROM_SPC6033P:
                f = nvrfopen("spc6033p.nvr", "rb");
                nvrmask = 127;
                break;
        case ROM_DELL200:
                f = nvrfopen("dell200.nvr", "rb");
                nvrmask = 127;
                break;
        case ROM_IBMAT386:
                f = nvrfopen("at386.nvr", "rb");
                nvrmask = 127;
                break;
        case ROM_DESKPRO_386:
                f = nvrfopen("deskpro386.nvr", "rb");
                break;
        case ROM_ACER386:
                f = nvrfopen("acer386.nvr", "rb");
                nvrmask = 127;
                break;
        case ROM_KMXC02:
                f = nvrfopen("kmxc02.nvr", "rb");
                nvrmask = 127;
                break;
        case ROM_MEGAPC:
                f = nvrfopen("megapc.nvr", "rb");
                nvrmask = 127;
                break;
        case ROM_AMA932J:
                f = nvrfopen("ama932j.nvr", "rb");
                nvrmask = 127;
                break;
        case ROM_AMI386SX:
        ...
        case ROM_AMI486:
                ...
                break;
        case ROM_WIN486:
                f = nvrfopen("win486.nvr", "rb");
                nvrmask = 127;
                break;
        case ROM_PCI486:
                f = nvrfopen("hot-433.nvr", "rb");
                nvrmask = 127;
                break;
        case ROM_SIS496:
                f = nvrfopen("sis496.nvr", "rb");
                nvrmask = 127;
                break;
        case ROM_P55VA:
                f = nvrfopen("p55va.nvr", "rb");
                nvrmask = 127;
                break;
        case ROM_P55TVP4:
                f = nvrfopen("p55tvp4.nvr", "rb");
                nvrmask = 127;
                break;
        case ROM_430VX:
                f = nvrfopen("430vx.nvr", "rb");
                nvrmask = 127;
                break;
        case ROM_REVENGE:
                f = nvrfopen("revenge.nvr", "rb");
                nvrmask = 127;
                break;
        case ROM_ENDEAVOR:
                f = nvrfopen("endeavor.nvr", "rb");
                nvrmask = 127;
                break;
        case ROM_P55T2P4:
                f = nvrfopen("p55t2p4.nvr", "rb");
                nvrmask = 127;
                break;
        case ROM_PX386:
                f = nvrfopen("px386.nvr", "rb");
                nvrmask = 127;
                break;
        case ROM_DTK386:
                f = nvrfopen("dtk386.nvr", "rb");
                nvrmask = 127;
                break;
        ...
        case ROM_EPSON_PCAX2E:
                f = nvrfopen("epson_pcax2e.nvr", "rb");
                nvrmask = 127;
                break;
        case ROM_PB_L300SX:
                f = nvrfopen("pb_l300sx.nvr", "rb");
                nvrmask = 127;
                break;
        case ROM_EPSON_PCAX3:
                f = nvrfopen("epson_pcax3.nvr", "rb");
                nvrmask = 127;
                break;
        case ROM_COMPAQ_PII:
                f = nvrfopen("compaq_pii.nvr", "rb");
                break;
        case ROM_T3100E:
        ...
        case ROM_ELX_PC425X:
                ...
                break;
        case ROM_PB570:
                f = nvrfopen("pb570.nvr", "rb");
                nvrmask = 127;
                break;
        case ROM_ZAPPA:
                f = nvrfopen("zappa.nvr", "rb");
                nvrmask = 127;
                break;
        case ROM_ITAUTEC_INFOWAYM:
                f = nvrfopen("infowaym.nvr", "rb");
                nvrmask = 127;
                break;
        case ROM_PB520R:
        ...
        case ROM_IBMPS2_M70_TYPE4:
                f = nvrfopen("ibmps2_m70_type4.nvr", "rb");
                break;
        case ROM_TULIP_TC7:
                f = nvrfopen("tulip_tc7.nvr", "rb");
                break;
        case ROM_PB410A:
                f = nvrfopen("pb410a.nvr", "rb");
                nvrmask = 127;
                break;
        case ROM_BULL_MICRAL_45:
                f = nvrfopen("bull_micral_45.nvr", "rb");
                break;
        case ROM_FIC_VA503P:
                f = nvrfopen("fic_va503p.nvr", "rb");
                nvrmask = 127;
                break;
        case ROM_CBM_SL386SX25:
                f = nvrfopen("cbm_sl386sx25.nvr", "rb");
                nvrmask = 127;
                break;
        case ROM_IBMPS1_2133_451:
                f = nvrfopen("ibmps1_2133.nvr", "rb");
                nvrmask = 127;
                break;
        case ROM_ECS_386_32:
                f = nvrfopen("ecs_386_32.nvr", "rb");
                nvrmask = 127;
                break;
        case ROM_VS440FX:
                f = nvrfopen("vs440fx.nvr", "rb");
                nvrmask = 127;
                break;
        case ROM_GA686BX:
                f = nvrfopen("ga686bx.nvr", "rb");
                nvrmask = 127;
                break;
...
void savenvr() {
        ...
        case ROM_PC1512:
                ...
                break;
        case ROM_PC1640:
                f = nvrfopen("pc1640.nvr", "wb");
                break;
        case ROM_PC200:
                f = nvrfopen("pc200.nvr", "wb");
                break;
        case ROM_PC2086:
                f = nvrfopen("pc2086.nvr", "wb");
                break;
        case ROM_PC3086:
                f = nvrfopen("pc3086.nvr", "wb");
                break;
        case ROM_PC5086:
                f = nvrfopen("pc5086.nvr", "wb");
                break;
        case ROM_PPC512:
                f = nvrfopen("ppc512.nvr", "wb");
                break;
        case ROM_IBMAT:
                f = nvrfopen("at.nvr", "wb");
                break;
        case ROM_IBMXT286:
                f = nvrfopen("ibmxt286.nvr", "wb");
                break;
        case ROM_IBMPS1_2011:
                f = nvrfopen("ibmps1_2011.nvr", "wb");
                break;
        case ROM_IBMPS1_2121:
                f = nvrfopen("ibmps1_2121.nvr", "wb");
                break;
        case ROM_IBMPS2_M30_286:
                f = nvrfopen("ibmps2_m30_286.nvr", "wb");
                break;
        case ROM_IBMPS2_M50:
                f = nvrfopen("ibmps2_m50.nvr", "wb");
                break;
        case ROM_IBMPS2_M55SX:
                f = nvrfopen("ibmps2_m55sx.nvr", "wb");
                break;
        case ROM_IBMPS2_M80:
                f = nvrfopen("ibmps2_m80.nvr", "wb");
                break;
        case ROM_CMDPC30:
                f = nvrfopen("cmdpc30.nvr", "wb");
                break;
        case ROM_AMI286:
                f = nvrfopen("ami286.nvr", "wb");
                break;
        case ROM_TG286M:
                f = nvrfopen("tg286m.nvr", "wb");
                break;
        case ROM_AWARD286:
                f = nvrfopen("award286.nvr", "wb");
                break;
        case ROM_GDC212M:
                f = nvrfopen("gdc212m.nvr", "wb");
                break;
        case ROM_HYUNDAI_SUPER286TR:
        ...
        case ROM_GW286CT:
                ...
                break;
        case ROM_SPC4200P:
                f = nvrfopen("spc4200p.nvr", "wb");
                break;
        case ROM_SPC4216P:
                f = nvrfopen("spc4216p.nvr", "wb");
                break;
        case ROM_SPC4620P:
                f = nvrfopen("spc4620p.nvr", "wb");
                break;
        case ROM_SPC6000A:
                f = nvrfopen("spc6000a.nvr", "wb");
                break;
        case ROM_SPC6033P:
                f = nvrfopen("spc6033p.nvr", "wb");
                break;
        case ROM_DELL200:
                f = nvrfopen("dell200.nvr", "wb");
                break;
        case ROM_IBMAT386:
                f = nvrfopen("at386.nvr", "wb");
                break;
        case ROM_DESKPRO_386:
                f = nvrfopen("deskpro386.nvr", "wb");
                break;
        case ROM_ACER386:
                f = nvrfopen("acer386.nvr", "wb");
                break;
        case ROM_KMXC02:
                f = nvrfopen("kmxc02.nvr", "wb");
                break;
        case ROM_MEGAPC:
                f = nvrfopen("megapc.nvr", "wb");
                break;
        case ROM_AMA932J:
                f = nvrfopen("ama932j.nvr", "wb");
                break;
        case ROM_AMI386SX:
        ...
        case ROM_AMI486:
                ...
                break;
        case ROM_WIN486:
                f = nvrfopen("win486.nvr", "wb");
                break;
        case ROM_PCI486:
                f = nvrfopen("hot-433.nvr", "wb");
                break;
        case ROM_SIS496:
                f = nvrfopen("sis496.nvr", "wb");
                break;
        case ROM_P55VA:
                f = nvrfopen("p55va.nvr", "wb");
                break;
        case ROM_P55TVP4:
                f = nvrfopen("p55tvp4.nvr", "wb");
                break;
        case ROM_430VX:
                f = nvrfopen("430vx.nvr", "wb");
                break;
        case ROM_REVENGE:
                f = nvrfopen("revenge.nvr", "wb");
                break;
        case ROM_ENDEAVOR:
                f = nvrfopen("endeavor.nvr", "wb");
                break;
        case ROM_P55T2P4:
                f = nvrfopen("p55t2p4.nvr", "wb");
                break;
        case ROM_PX386:
                f = nvrfopen("px386.nvr", "wb");
                break;
        case ROM_DTK386:
                f = nvrfopen("dtk386.nvr", "wb");
                break;
        case ROM_MR386DX_OPTI495:
        ...
        case ROM_EPSON_PCAX:
                ...
                break;
        case ROM_EPSON_PCAX2E:
                f = nvrfopen("epson_pcax2e.nvr", "wb");
                break;
        case ROM_EPSON_PCAX3:
                f = nvrfopen("epson_pcax3.nvr", "wb");
                break;
        case ROM_COMPAQ_PII:
                f = nvrfopen("compaq_pii.nvr", "wb");
                break;
        case ROM_PB_L300SX:
                f = nvrfopen("pb_l300sx.nvr", "wb");
                break;
        case ROM_T3100E:
        ...
        case ROM_ELX_PC425X:
                ...
                break;
        case ROM_PB570:
                f = nvrfopen("pb570.nvr", "wb");
                break;
        case ROM_ZAPPA:
                f = nvrfopen("zappa.nvr", "wb");
                break;
        case ROM_ITAUTEC_INFOWAYM:
                f = nvrfopen("infowaym.nvr", "wb");
                break;
        case ROM_PB520R:
        ...
        case ROM_IBMPS2_M70_TYPE3:
                ...
                break;
        case ROM_IBMPS2_M70_TYPE4:
                f = nvrfopen("ibmps2_m70_type4.nvr", "wb");
                break;
        case ROM_TULIP_TC7:
                f = nvrfopen("tulip_tc7.nvr", "wb");
                break;
        case ROM_PB410A:
                f = nvrfopen("pb410a.nvr", "wb");
                break;
        case ROM_BULL_MICRAL_45:
                f = nvrfopen("bull_micral_45.nvr", "wb");
                break;
        case ROM_FIC_VA503P:
                f = nvrfopen("fic_va503p.nvr", "wb");
                break;
        case ROM_CBM_SL386SX25:
                f = nvrfopen("cbm_sl386sx25.nvr", "wb");
                break;
        case ROM_IBMPS1_2133_451:
                f = nvrfopen("ibmps1_2133.nvr", "wb");
                break;
        case ROM_ECS_386_32:
                f = nvrfopen("ecs_386_32.nvr", "wb");
                break;
        case ROM_VS440FX:
                f = nvrfopen("vs440fx.nvr", "wb");
                break;
        case ROM_GA686BX:
                f = nvrfopen("ga686bx.nvr", "wb");
                break;
